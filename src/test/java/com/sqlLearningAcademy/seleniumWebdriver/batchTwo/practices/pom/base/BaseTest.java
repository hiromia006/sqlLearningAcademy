package com.sqlLearningAcademy.seleniumWebdriver.batchTwo.practices.pom.base;
    ...
    public BaseTest() {
        try {
            ...
            String filePath = System.getProperty("user.dir")
                    + "/src/test/java/com/sqlLearningAcademy/seleniumWebdriver/batchTwo/practices/pom/config/config.Properties";
